...
/**
 * Group sessions by time period (Today, Yesterday, This Week, etc.)
 *
 * @param {Array<Object>} sessions - Array of session objects
 * @returns {Object} Sessions grouped by time period
 *
 * @example
 ...
 * // }
 */
export function groupSessionsByPeriod(sessions) {
  if (!Array.isArray(sessions)) {
